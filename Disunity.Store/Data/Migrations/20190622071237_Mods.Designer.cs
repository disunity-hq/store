...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Disunity.Store.Models.Mod", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Disunity.Store.Models.ModVersion", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Disunity.Store.Models.ModVersionDownloadEvent", b =>
                {
                    ...
                    b.ToTable("ModVersionDownloadEvent");
                });
            ...
            modelBuilder.Entity("Disunity.Store.Models.UserIdentity", b =>
                {
            ...
            modelBuilder.Entity("Disunity.Store.Models.Mod", b =>
                {
                    b.HasOne("Disunity.Store.Models.ModVersion", "Latest")
                        .WithOne("Mod")
            ...
            modelBuilder.Entity("Disunity.Store.Models.ModVersion", b =>
                {
                    b.HasOne("Disunity.Store.Models.Mod")
                        .WithMany("Versions")
                        .HasForeignKey("ModId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Disunity.Store.Models.ModVersion")
            ...
            modelBuilder.Entity("Disunity.Store.Models.ModVersionDownloadEvent", b =>
                {
                    b.HasOne("Disunity.Store.Models.ModVersion", "ModVersion")
                        .WithMany()
                        .HasForeignKey("ModVersionId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Disunity.Store.Models.OrgMember", b =>
                {
                    ...
                    b.HasOne("Disunity.Store.Models.UserIdentity", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Disunity.Store.Models.UserIdentity")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
